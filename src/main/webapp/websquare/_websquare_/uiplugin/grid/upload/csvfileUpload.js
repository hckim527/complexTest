...
scwin.sendFILE_onclick = function (e) {
  try {
    ...
    scwin.isCSVFile = scwin.endsWith(scwin.filename.toLowerCase(), ".csv") == true || scwin.endsWith(scwin.filename.toLowerCase(), ".txt") == true;
    if (!scwin.isCSVFile) {
